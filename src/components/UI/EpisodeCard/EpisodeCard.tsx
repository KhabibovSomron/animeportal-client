...
const EpisodeCard: FC<IEpisodeCardProps> = ({toggleShow}) => {
    return (
        <div className="card card-dv" onClick={()=>toggleShow()}>
            ...
            <div className="card-body">
                <h5 className="anime-title">Твоё имя</h5>
                <h5 className="card-title">1 серия – Магические камни</h5>
