...
import { resetPaswordConfirm, signUpActicate } from '../../../redux/actions/UserActions';
    ...
    return (
        <div className='col-lg-9'>
            <div className='container-password'>
                <button className="btn btn-dark" style={{ width: '100%' }} onClick={onEmailConfirmClick} >Подтвердить Электроную почту</button>
            </div>
